...
BEGIN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_2 = '1' AND Write_Done_1 = '1' THEN
...
--	handshake_FIR_register : component reg_adc
--		generic map (
--			DATA_WIDTH     => 12
--		)
--		port map (
--			clk        => clk,                           --    clk.clk
--			rst_L      => reset,           					 --    clk_reset.reset
--			reg_din    => reg_data_out,                       --    data_out to register data_in
--			ld_reg     => rsp_valid,                        --    load_register
--			reg_dout   => filter_in(11 downto 0)                        --    register data out     
--		);
