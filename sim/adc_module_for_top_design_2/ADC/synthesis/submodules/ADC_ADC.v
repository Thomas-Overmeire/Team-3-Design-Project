...
module ADC_ADC #(
		...
		output wire [11:0] control_internal_response_data,           //**** control_internal:rsp_data -> sample_store_internal:rsp_data****
		output wire        sequencer_internal_command_ready,           //****            control_internal:cmd_ready -> sequencer_internal:cmd_ready for output wire****
		output wire        control_internal_response_valid,					//**** control_internal:rsp_valid -> sample_store_internal:rsp_valid****
		output wire        control_internal_response_startofpacket,			// control_internal:rsp_sop -> sample_store_internal:rsp_sop*****
		output wire        control_internal_response_endofpacket  			// control_internal:rsp_eop -> sample_store_internal:rsp_eop*****
	);
