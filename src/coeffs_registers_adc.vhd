-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\dspprogfirhdl\coeffs_registers_adc.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: coeffs_registers_adc
-- Source Path: dspprogfirhdl/Programmable FIR via Registers/coeffs_registers_adc
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY coeffs_registers_adc IS
...
END coeffs_registers_adc;


ARCHITECTURE rtl OF coeffs_registers_adc IS
